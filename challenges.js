...
function nextPlayer() {
	//Next player
	activePlayer === 0 ? activePlayer = 1 : activePlayer = 0; // could write an if/else statement
	/*
		if (activePlayer === 0) {
			activePlayer = 1;
		} else {
...
function init() {
	...
	document.getElementById('dice-1').style.display = 'none'; //select a class
	document.getElementById('dice-2').style.display = 'none'; //select a class
